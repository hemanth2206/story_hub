            ...
            {/* edit & delete */}
            {
              currentUser.role === 'author' && (
                <div className="d-flex me-2">
                  {/* edit button */}
                  <button className="me-3 btn btn-light btn-sm" onClick={enableEdit}>
                    <FaEdit className='text-warning' />
                  </button>
                  {/* if article is active,display delete icon, otherwise display restore icon */}
                  {
                    state.isArticleActive === true ? (
                      <button className="me-2 btn btn-light btn-sm" onClick={deleteArticle}>
                        <MdDelete className='text-danger fs-4 ' />
                      </button>
                    ) : (
                      <button className="me-2 btn btn-ligh btn-sm" onClick={restoreArticle}>
